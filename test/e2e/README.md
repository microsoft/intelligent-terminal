...
| `Feature.HookTrace.Tests.ps1` | C190, C267-C269, C272, C344-C345: guarded commands deliver, sensitive payloads stay private, outside-Terminal hooks are ignored, and Antigravity CLI identity/idle/error handling stays source-correct | 7 |
