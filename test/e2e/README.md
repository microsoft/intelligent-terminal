...
| `Feature.SharedAgentLifecycle.Tests.ps1` | PR #425 + #637: closing a tab mid-turn physically closes only its ACP session without terminating the shared agent CLI or breaking sibling tabs | 1 |
