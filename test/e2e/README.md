...
| `Feature.AgentInputUndoRedo.Tests.ps1` | Physical Ctrl+Z/Ctrl+Y: grouped typing, atomic replacement/cut/deletion and idle clearing, multiline Unicode source/caret roundtrips, redo branching, and submission/prompt-history boundaries. Deterministic ACP fixture; exact clipboard/capture evidence under `ITE2E_ARTIFACT_ROOT`; requires an already loaded English (US) layout and an unused explicitly selected package | 5 |
