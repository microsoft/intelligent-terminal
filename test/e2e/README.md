...
| `Feature.YoloMode.Tests.ps1` | Default-provider-scoped automatic approval persistence, deterministic permission boundary, `/agent` inheritance, hidden unsupported/policy states, retained Gemini guidance, and live policy reconciliation | 7 (OpenCode, Gemini, `/agent`, and policy gated) |
