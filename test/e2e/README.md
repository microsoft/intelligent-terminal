...
| `Feature.AgentsSettingsFeedback.Tests.ps1` | Agent CLI shortcuts/context, ACP/delegate Save/Edit/reselect consistency, preview/input alignment, equal-width model inputs, and help-link hit targets/baselines | 5 |
