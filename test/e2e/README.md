...
| `Feature.YoloMode.Tests.ps1` | Default-provider-scoped Yolo persistence, deterministic permission boundary, `/agent` inheritance, provider compatibility notices, and live policy reconciliation | 7 (OpenCode, Gemini, `/agent`, and policy gated) |
