...
| `Feature.TmuxReconnect.Tests.ps1` | Physical tab selection across reattachment; index-based native tab order, silent swaps/renumbering, insertion/removal, and stable pane/tab identity | 2 (SSH-gated) |
