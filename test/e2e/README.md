...
**Coverage: 111 of 113 automatable `[E2E]` checklist items are implemented.**
**Test status: 105 baseline feature cases pass + 2 documented skips** (`wta sessions list` is
...
case, an installed+authenticated native agent) is available. The 111 implemented checklist
