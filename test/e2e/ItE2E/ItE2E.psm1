...
$publicFns = @(
    ...
    'Open-AgentPane', 'Set-AgentPaneFocus', 'Wait-AgentReady', 'Get-AgentCliStatus', 'Get-AgentAcpStatus', 'Get-WtaLocalizedTextRegex', 'Get-WtReswTextValues', 'Get-WtReswTextRegex', 'Get-RecommendationCardRegex', 'Get-PendingTerminalActionProposal', 'Wait-TerminalActionProposal', 'Resolve-AgentOwnerTabId', 'Send-AgentPrompt', 'Wait-AgentState',
