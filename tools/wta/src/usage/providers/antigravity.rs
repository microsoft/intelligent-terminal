...
pub(super) struct AntigravityUsageAdapter;

pub(super) static ADAPTER: AntigravityUsageAdapter = AntigravityUsageAdapter;

impl ProviderUsageAdapter for AntigravityUsageAdapter {
