...
mod tests {
    ...
    use super::{
        ...
        retire_queued_prompt_submissions, stop_prompt_tasks, timeout_result_failure_fields,
        tool_call_exit_code, tool_call_kind_label, tool_call_location_hint, tool_call_target,
        AcpClientExit, ClientState, PromptDispatchCleanup, PromptSubmission, PromptTask,
