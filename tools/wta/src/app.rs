...
impl App {
    ...
    /// the session and lets the C++ side rebuild the tab. When the saved tab
    /// had an agent pane, resolve its WT pane GUID to the ACP session id so WT
    /// can resume that conversation into the rebuilt tab.
