...
pub(crate) enum Command {
    ...
    /// Serve the session-bound Intelligent Terminal proposal tool over MCP
    /// stdio. Spawned by an ACP agent from session MCP configuration.
    #[command(hide = true)]
    ProposalMcpServer {
        /// Owning Helper's proposal named pipe.
        #[arg(long)]
        pipe: String,
        /// Opaque session capability generated by the owning Helper.
        #[arg(long)]
        capability: String,
    },
}
