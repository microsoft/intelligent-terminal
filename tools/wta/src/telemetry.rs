...
//
// WTA registers its OWN provider, `Microsoft.Windows.Terminal.WTA` — separate
// from the C++ side's `Microsoft.Windows.Terminal.App`; it must not reuse that
// provider. The provider definition and the keyword/privacy constants are
