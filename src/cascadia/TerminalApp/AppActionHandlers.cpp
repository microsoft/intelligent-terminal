...
namespace winrt::TerminalApp::implementation
{
    namespace
    {
        ...
        // profile.Name(), which is a user-renamable display field.
        // Falls back to Name() when the commandline parse fails.
        //
        // (Duplicated from FreOverlay.cpp — small + symmetric.
        // Promote to a shared helper if a third call site arrives.)
        inline std::wstring _ExtractWslDistroName(const Profile& profile)
        {
        ...
        // concurrently with a settings reload is a use-after-mutate.
        inline std::vector<std::wstring> _SnapshotWslDistroNames(const CascadiaSettings& settings)
        {
