...
namespace winrt::TerminalApp::implementation
{
    ...
    private:
        ...
        // Deferred tab initialization consumes a resume target before ordinary
        // prewarm and passes it as --initial-load-session-id/--initial-load-cwd.
        // OnAgentStateChanged must not spawn a blank pane while this is pending.
        // A tab closed before initialization leaves its request until page teardown.
