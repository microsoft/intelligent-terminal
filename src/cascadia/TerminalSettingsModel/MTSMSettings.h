...
#define MTSM_GLOBAL_SETTINGS(X)                                                                                                                                                                       \
    ...
    X(bool, EnableShellCompletionMenu, "experimental.enableShellCompletionMenu", true)                                                                                                                \
    X(bool, AutoTriggerShellCompletion, "experimental.autoTriggerShellCompletion", false)                                                                                                              \
