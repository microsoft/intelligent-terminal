...
#define MTSM_GLOBAL_SETTINGS(X)                                                                                                                                                                       \
    ...
    X(bool, InlineSuggestionsEnabled, "experimental.inlineSuggestions.enabled", true)                                                                                                                   \
    X(int32_t, InlineSuggestionsDebounceMs, "experimental.inlineSuggestions.debounceMs", 300)
