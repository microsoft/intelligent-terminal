...
default. It renders the active pane's status, working directory, repository,
branch, agent usage/cost, agent context window, and agent model when those
values are available. Git status includes upstream ahead/behind counts.
