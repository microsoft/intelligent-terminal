                                ...
                                ITerminalProtocol>
{
    ...
    STDMETHODIMP ListDurableTabSessions(BSTR* json) override;
    ...
    STDMETHODIMP RestoreDurableTabSession(unsigned __int64 windowId, BSTR id) override;
...
private:
    ...
    static void _annotateDurableTabSessions(Json::Value& sessions);
