...
namespace SettingsModelUnitTests
{
    class CommandTests : public JsonTestClass
    {
        ...
        TEST_METHOD(TestWorkspaceRestoreCommandline);
    };
    ...
    void CommandTests::TestWorkspaceRestoreCommandline()
    {
        NewTerminalArgs args;
        args.UseWorkspaceBuffer(true);
        VERIFY_ARE_EQUAL(winrt::hstring{ L"--useWorkspaceBuffer" }, args.ToCommandline());
    }
