...
- [ ] `C280` `[new]` `[UT✓]` `[E2E]` **Clarification modal returns the selected answer to the requesting ACP session:** A blocking agent question renders its choices, supports Left/Right editing in its freeform response, and returns the exact choice/index or cursor-edited answer to the owning ACP session. _(#606; E2E: `Feature.AgentProtocolExperience`.)_
