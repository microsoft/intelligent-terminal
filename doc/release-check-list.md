...
- [ ] `C290` `[new]` `[UT✓]` `[E2E]` **Yolo never answers ACP permissions:** Even while global Yolo is enabled, an ACP `session/request_permission` remains pending until the user explicitly selects a provider option. _(PR #505; UT: permission responder tests; E2E: `Feature.YoloMode`.)_
