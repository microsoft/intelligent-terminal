...
- [ ] `C318` `[new]` `[E2E]` **Agent draft undo and redo groups contiguous typing:** Physical Ctrl+Z removes one contiguous typing group without removing an earlier pasted prefix; Ctrl+Y restores that exact group without submitting. _(E2E: `Feature.AgentInputUndoRedo`.)_
