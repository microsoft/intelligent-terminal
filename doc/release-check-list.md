...
- [ ] `C288` `[new]` `[E2E]` **Background tabs do not pre-warm unused agent helpers:** Creating an unselected background tab does not start another helper or ACP session; selecting it materializes the helper on demand. _(E2E: `Feature.AgentPaneInteraction`.)_
