...
- [ ] `C312` `[new]` `[E2E]` **Multiline agent input arrows edit explicit rows:** Physical Up/Down moves through logical newline rows before inserting text, keeps the edited row visible, and preserves exact Unicode source text. _(E2E: `Feature.AgentInputNavigation`.)_
- [ ] `C313` `[new]` `[E2E]` **Multiline agent input preserves the preferred display column:** Vertical movement clamps on a short row and recovers the intended column on the next long row. _(E2E: `Feature.AgentInputNavigation`.)_
- [ ] `C314` `[new]` `[E2E]` **Soft-wrapped agent input arrows edit visual rows:** Physical Up/Down moves by a rendered row within one logical line using width discovered from the live pane. _(E2E: `Feature.AgentInputNavigation`.)_
- [ ] `C315` `[new]` `[E2E]` **Selected agent input arrows collapse without deleting text:** After Ctrl+A, Up collapses to the source start and Down collapses to the source end before ordinary typing. _(E2E: `Feature.AgentInputNavigation`.)_
- [ ] `C316` `[new]` `[E2E]` **Agent input arrow boundaries preserve prompt history:** At an input boundary, physical Up/Down retains deterministic prompt recall and restoration behavior. _(E2E: `Feature.AgentInputNavigation`.)_
