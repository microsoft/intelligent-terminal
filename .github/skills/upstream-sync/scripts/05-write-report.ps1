...
param(
    ...
    [Parameter(Mandatory)] [ValidateSet('ok','no-op','stuck','skipped-locked','stuck-static-scan','stuck-build-failed','stuck-build-inconclusive','stuck-toolchain-missing')] [string] $Status
)
