...
> [!NOTE]
> Intelligent Terminal requires Windows 11 22H2 or later (22621.0+). You also need a supported agent CLI and subscription. [GitHub Copilot](https://github.com/features/copilot/cli/) is the default.
